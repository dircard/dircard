...
### Fixed
- Fix list formatting with inline elements such as code or links
- Remove the extra trailing newline from rendered output
...
[0.3.1]: https://github.com/dircard/dircard/releases/tag/v0.3.1
